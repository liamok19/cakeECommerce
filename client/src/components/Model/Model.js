  ...
  return (
    <group ref={group} {...props} dispose={null}>
      ...
      <mesh
        ...
        material={materials["bushcake.002"]}
        position={[-2.76, 0.15, -1.05]}
        scale={0.32}
      />
      <mesh
        castShadow
        ...
        material={materials["bushcake.003"]}
        position={[-4.75, 0.13, -3.67]}
        scale={0.22}
      />
      <mesh
        castShadow
        ...
        material={materials["bushcake.004"]}
        position={[-4.67, 0.09, -2.56]}
        scale={0.13}
      />
      <mesh
        castShadow
        ...
        material={materials["bushcake.005"]}
        position={[-4.34, 0.09, -3.16]}
        scale={0.16}
      />
      <mesh
        castShadow
        ...
        material={materials["bushcake.006"]}
        position={[-2.78, 0.08, -5.46]}
        scale={0.16}
      />
      <mesh
        castShadow
        ...
        material={materials["bushcake.007"]}
        position={[-3.11, 0.08, -4.86]}
        scale={0.13}
      />
      <mesh
        castShadow
        ...
        material={materials["bushcake.008"]}
        position={[-3.19, 0.12, -5.97]}
        scale={0.22}
      />
